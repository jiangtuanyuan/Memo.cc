package com.example.notes.swipe.swipebacklayout.lib;
...
public class SwipeBackLayout extends FrameLayout {
     ...
     * @param   of edge flags describing the edge to set
     * @see #EDGE_LEFT
     * @see #EDGE_RIGHT
     * @see #EDGE_BOTTOM
     */
     ...
     * @param  Combination of edge flags describing the edge to set
     * @see #EDGE_LEFT
     * @see #EDGE_RIGHT
     * @see #EDGE_BOTTOM
     */
