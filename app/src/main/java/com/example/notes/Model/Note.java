...
public class Note extends Item implements Serializable, Comparable {
    ...
    private com.example.notes.Model.Date deleteDate;

    private int level;


    public Note(String name, com.example.notes.Model.Date date, String folderName) {
    ...
    public Note(String name, com.example.notes.Model.Date date,
