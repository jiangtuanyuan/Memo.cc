...
public class AboutActivity extends BaseActivity {
    ...
    private void chooseCopyContent(){
        ...
        dialog.setChoose1("WeChat");
        dialog.setListener_1(new MyOnClickListener() {
            @Override
            public void onClick() {
                ClipboardManager manager = (ClipboardManager) getSystemService(Context.CLIPBOARD_SERVICE);
                manager.setText("king3203416279");
                MsgToast.showToast(AboutActivity.this,"复制WeChat成功!");

            }
        });

        dialog.setChoose2("QQ");
        dialog.setListener_2(new MyOnClickListener() {
            @Override
            public void onClick() {
                ClipboardManager manager = (ClipboardManager) getSystemService(Context.CLIPBOARD_SERVICE);
                manager.setText("3203416279");

                MsgToast.showToast(AboutActivity.this,"复制QQ成功!");
            }
        });
